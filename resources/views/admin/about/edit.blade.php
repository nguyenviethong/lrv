...
@section('content')
    <form action="{{ route('admin.about.update', $about) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <textarea name="intro" class="form-control">{{ old('intro', $about->intro) }}</textarea>
        </div>
        ...
        <div class="form-group">
            <label>Ảnh</label><br>
            @if($about->image)
                <img src="{{ asset('storage/'.$about->image) }}" width="150" class="mb-2">
            @endif
        ...
        <div id="items-wrapper">
            ...
            @foreach($items as $index => $item)
                <div class="item-group border p-2 mb-2 position-relative">
                    <button type="button" class="btn btn-danger btn-sm bottom-0 end-0 m-1 remove-item">
